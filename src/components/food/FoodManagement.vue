    ...
    <div>
        <el-card>
            <el-row :gutter="25">
                ...
                <el-col :span="2">
                    <el-button type="primary" @click="addShow" v-hasPermission="['FOOD_ADD']">添加食物</el-button>
                </el-col>
                <!-- 管理员或超级管理员才可以批量导入 -->
                <el-col :span="2" v-hasRole="['ROLE_SUPERADMIN', 'ROLE_ADMIN']">
                    <el-upload
                            :action="importUrl"
                            :headers="headers"
                            name="file"
            ...
            <el-table :data="tableList" border stripe>
                ...
                <el-table-column label="热量" prop="calories"/>
                <el-table-column label="蛋白质" prop="protein"/>
                <el-table-column label="脂肪" prop="fat"/>
                <el-table-column label="碳水化合物" prop="carbohydrate"/>
                ...
                <el-table-column label="胡萝卜素" prop="carotene"/>
